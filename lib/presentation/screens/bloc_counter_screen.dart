    ...
    return Scaffold(
      appBar: AppBar(
        title: context.select((CounterBloc counterBloc) {
          return Text('Cubit Counter: ${counterBloc.state.transactionCount}'); //esto es lo mismo que usar BlocBuilder
        }),
        actions: [
          IconButton(
      ...
      body: Center(
        child: context.select((CounterBloc counterBloc) {
          return Text(
              'Cubit Counter: ${counterBloc.state.counter}'); //esto es lo mismo que usar BlocBuilder
        }),
      ),
